...
class DrawingEngine:
    ...
    def _draw_mounting_bracket_side_view(self):
        ...
        self.utils.add_primary_dimension(ax, (-75, 0), (-75, mb_specs.U_ARM_OVERALL_HEIGHT), '200', vertical=True, offset=-3)
    ...
    def _draw_mounting_bracket_front_view(self):
        ...
        # === ASSEMBLY DETAIL ===
        self.utils.add_manufacturing_detail(ax, (mb_specs.BASE_PLATE_RIGHT - mb_specs.U_ARM_WALL_THICKNESS, 0), 
                                          'FLUSH WITH\nBACK EDGE', (20, 60), 'red')
