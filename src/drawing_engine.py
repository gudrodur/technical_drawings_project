...
class DrawingEngine:
    ...
    def _draw_mounting_bracket_side_view(self):
        ...
        self.utils.format_professional_layout(ax, title_with_scale, (-90, 240), (-80, 220), 'X (mm)', 'Z (mm)')
        ...
        self.utils.add_comprehensive_notes(ax, mb_specs.MATERIAL, (220, -70), manufacturing_details)
